...
public class DeveloperController {
    ...
    public DeveloperResponse save(@RequestBody Developer developer){
        ...
        return new DeveloperResponse(createdDeveloper, HttpStatus.CREATED.value(),"crete islemi basarili");
    }
    ...
    public DeveloperResponse getById(@PathVariable("id") int id){
        ...
        if (foundDeveloper == null){
            return new DeveloperResponse(null, HttpStatus.NOT_FOUND.value(), "bulunamadi");
        }
        return new DeveloperResponse(foundDeveloper, HttpStatus.OK.value(),"search basarili");
    }
